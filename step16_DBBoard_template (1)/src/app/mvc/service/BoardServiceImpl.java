...
public class BoardServiceImpl implements BoardService {
	...
	public List<BoardDTO> boardSelectAll() throws SearchWrongException {
		...
		if(list.isEmpty())													//이미 DAO에서 ArrayList로 만들었기 때문에 null이 아닌 isEmpty로 확인해야함.
	...
	public void boardUpdate(BoardDTO boardDTO) throws DMLException 
	{
		...
		if(result==0)
			throw new DMLException("수정되지 못했습니다.");
	...
	public void boardDelete(int boardNo) throws DMLException 
	{
		...
		if(result==0)
			throw new DMLException("삭제되지 못했습니다.");
	...
	{
		List <BoardDTO>list = boardDao.replySelectByParentNo2();
