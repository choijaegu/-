    ...
    * */
    public static void menuChoice() {
         while(true) {
         	...
         	System.out.print("0. 부모글의 댓글정보검색  ");
				  ...
				  case 1:
	               ...
	               case 8: //부모글의 댓글정보 검색
	            	   inputSelectReplyByParentNo();
	    				break;	
	               case 0:
	            	   BoardController.replySelectByParentNo2();
	    				break;	
	               case 9:
     ...
     * */
     public static void inputInsertBoard() {
    	 ...
    	 BoardDTO board =  new BoardDTO(0, subject, writer, content, null);		//생성자를 오버라이딩하기 싫으면 이렇게 넣어주면 됨. 어차피 boardNo는 안쓰니까. 
     ...
     * */
     ...
     public static void inputInsertReply() {
    	//키보드 입력으로 댓글내용 , 등록하려는 부모글번호 입력받는다.
    	 ...
    	 //ReplyDTO reply = new ReplyDTO(ReplyContent, boardNo);
    	 //BoardController.replyInsert(reply);
    	 
    	 BoardController.replyInsert(new ReplyDTO(replyContent, boardNo));		//new ReplyDTO(replyContent,boardNo)라는 생성자를 인수로 보냄
